...
with DAG(
    ...
    check_file_exists = GCSObjectExistenceSensor(
        ...
        bucket='bkt-global-data',  # Replace with your bucket name
    ...
    load_csv_to_bigquery = GCSToBigQueryOperator(
        ...
        destination_project_dataset_table='qwiklabs-gcp-04-b7c1d16e0354.staging_dataset.global_data',  # Replace with your project, dataset, and table name
        source_format='CSV',
